...
- **Otomatik Test Kapsamı:** Çekirdek agent akışları, RAG parçalama, self-healing doğrulaması ve yerelleştirme `tests/` altındaki 100+ otomatik birim testi ile kapsanmıştır. Tam UI E2E test paketi genişletilmeye devam etmektedir.
